        ...
        if os.path.exists(folder_path):
         ...
         def chuder():
          try:
           ...
           ts.setText("start failed, please check your system")
         ...
         msg2.setText("png folder not found, please check your system")
...
class Window2(QWidget):
    ...
    def tolls(self):
         ...
         # 创建一个按钮
         butto1n = QPushButton('Open the system custom tool collection', self)
        ...
        #github
         ...
         def open_i():
             ...
             #我们只是让各个作者自定义 
             msg.setText("we just let each author customize")
